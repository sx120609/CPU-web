...
| `appName` | `药大垎坊课表` | 桌面显示名称 |

示例：

```bash
gradle :app:assembleRelease -PappUrl=https://cpu.lizmt.cn/schedule -PapplicationId=cn.lizmt.cpuweb.schedule -PappName=药大垎坊课表
```
