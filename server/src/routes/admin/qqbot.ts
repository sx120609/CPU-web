...
const groupUpsertSchema = z.object({
  ...
  assistantReplyQrCodeEnabled: z.boolean().optional(),
  ...
  adFilterWhitelistBlockQrCodeEnabled: z.boolean().optional(),
...
qqBotAdminRouter.post("/groups", validate(groupUpsertSchema), async (req, res, next) => {
  try {
    ...
    const payload = {
      ...
      assistantReplyQrCodeEnabled: req.body.assistantReplyQrCodeEnabled,
      ...
      adFilterWhitelistBlockQrCodeEnabled: req.body.adFilterWhitelistBlockQrCodeEnabled,
