...
export const COMMUNITY_BOARD_DEFS: readonly CommunityBoardDefinition[] = [
  ...
  { slug: "treehole", name: "树洞", description: "想说的话、烦恼和碎碎念都可以发这里", icon: "🕳️", color: "#6366f1", type: "normal" },
  ...
  { slug: "market", name: "二手市场", description: "教材 / 自行车 / 数码 / 个人闲置", icon: "🛒", color: "#ef4444", type: "market" },
