...
// @version      2.1.6
// @author       shushoujiu
// @description  药大拾间桌面端内置的学习通答题辅助：自动完成任务点，章节测验与考试由校园 AI 作答。运行参数由客户端「工具 → 刷题」下发。
...
// 自定义题库与校园 AI），但宿主正是按这里的 @connect 决定脚本能访问哪些域名，
...
// 本分支只经宿主调用药大拾间的校园 AI，没有任何第三方题库与付费入口。
...
(async function (vue, pinia$1, ElementPlus, md5, $$1) {
  ...
  class ServerApi {
    constructor(window2 = _unsafeWindow) {
      ...
      // 答案只来自自定义题库与校园 AI。对应的 @connect 也一并撤了。
