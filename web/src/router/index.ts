  ...
  routes: [
    ...
    { path: "/register", name: "register", component: () => import("@/views/Register.vue"), meta: { public: true, title: "注册" } },
    {
      ...
      children: [
        ...
        { path: "services/tools/filestore-beta", name: "service-filestore-beta", component: () => import("@/views/services/FileStoreBeta.vue"), meta: { title: "文件收集 beta" } },
        { path: "services/tools/filestore-beta/submit/:slug", name: "service-filestore-beta-submit", component: () => import("@/views/services/FileStoreBetaSubmit.vue"), meta: { title: "文件提交 beta", public: true } },
        { path: "services/tools/filestore-beta/status/:slug", name: "service-filestore-beta-status", component: () => import("@/views/services/FileStoreBetaStatus.vue"), meta: { title: "成功名单 beta", public: true } },
