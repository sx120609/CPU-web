  ...
  routes: [
    ...
    { path: "/register", name: "register", component: () => import("@/views/Register.vue"), meta: { public: true, title: "注册" } },
    {
      ...
      children: [
        ...
        { path: "services/tools/radio-beta", name: "service-radio-beta", component: () => import("@/views/services/RadioBeta.vue"), meta: { title: "药苑之声beta", public: true, fullWidthContent: true } },
