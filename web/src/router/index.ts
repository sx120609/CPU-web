  ...
  routes: [
    ...
    { path: "/register", name: "register", component: () => import("@/views/Register.vue"), meta: { public: true, title: "注册" } },
    {
      ...
      children: [
        ...
        { path: "services/tools/radio-beta", name: "service-radio-beta", component: () => import("@/views/services/RadioBeta.vue"), meta: { title: "药苑之声 beta", public: true, fullWidthContent: true } },
        { path: "services/tools/radio-beta/console", name: "service-radio-beta-console", component: () => import("@/views/services/RadioBetaConsole.vue"), meta: { title: "药苑之声控制台", public: true, fullWidthContent: true } },
