...
html[data-theme="dark"] .glass-base { background: linear-gradient(165deg, #202733a6, #1118278c 45%, #20273399); box-shadow: 0 3px 12px #0003, inset 0 1px .5px #ffffff73, inset 1px 0 .5px #ffffff26, inset 0 -1px .5px #0006; }
