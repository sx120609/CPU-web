  ...
  <div class="lost-found-page">
    <section class="hero">
      ...
      <div class="hero-visual" aria-hidden="true">
        <div class="visual-card found-card">
          <span class="visual-kicker">FOUND</span>
          <strong><el-icon><Location /></el-icon> 捡到物品</strong>
          <small>留下时间与地点线索</small>
        </div>
        <div class="visual-link"><span></span><el-icon><Search /></el-icon><span></span></div>
        <div class="visual-card lost-card">
          <span class="visual-kicker">LOST</span>
          <strong><el-icon><Search /></el-icon> 寻找物品</strong>
          <small>站内提交认领信息</small>
        </div>
      </div>
    </section>
