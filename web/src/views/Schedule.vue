<template>
  <main class="schedule-page" :class="{ 'theme-color-glass': scheduleTheme === 'color-glass' }">
    <header class="top">
      <el-select
        v-if="parsed"
        v-model="semester"
...
import { ArrowLeft, ArrowRight, Brush, ChatDotRound, Download, Loading, Lock, Moon, Picture, Refresh } from "@element-plus/icons-vue";
...
.theme-color-glass {
  background:
    radial-gradient(circle at 16% 2%, rgba(125, 211, 252, 0.44), transparent 28%),
    radial-gradient(circle at 88% 10%, rgba(196, 181, 253, 0.38), transparent 30%),
    radial-gradient(circle at 46% 98%, rgba(134, 239, 172, 0.30), transparent 34%),
    linear-gradient(180deg, #eef7ff 0%, #f8fbff 46%, #f8fafc 100%);
}
