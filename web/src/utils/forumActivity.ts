...
export const CAMPUS_LIFE_ACTIVITY = {
  ...
  funding: "这 200 元，来自用户的暖心赞助，也有开发者自己添上的心意；公布的奖项数量只是最低数量，参与越热闹，奖励只多不少。",
  judging: "评选将综合点赞数、回复数与内容质量；内容质量由拾间大模型和论坛管理员共同评定。暖心回复奖与投稿奖不可兼得。",
  compactRule: "总奖金 200 元 · 点赞、回复与内容质量综合评选",
} as const;
