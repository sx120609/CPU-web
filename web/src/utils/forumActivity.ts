...
export const CAMPUS_LIFE_ACTIVITY = {
  ...
  intro: "食堂、周边、校园此刻和每一种普通日常，都值得被同学看见。不知道属于哪一类，也可以使用日常分享参与评比。也欢迎其他平台的优秀创作者，带着原创内容来到药大拾间。",
...
export const CAMPUS_LIFE_ACTIVITY_THEMES = [
  ...
  },
  {
    key: "fun",
    label: "日常分享",
    description: "不知道选哪类，就从这里参加",
    icon: "forum",
    mode: "say",
    titlePlaceholder: "",
    prompt: "不知道帖子属于哪一类也没关系，校园生活里的其他见闻、感受和小事都可以从这里参加评比。",
  },
] as const;
