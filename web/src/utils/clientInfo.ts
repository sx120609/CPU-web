...
export const ANDROID_APP_LATEST_VERSION_CODE = 7;
export const ANDROID_APP_LATEST_VERSION_NAME = "1.6.0";
export const ANDROID_APP_DOWNLOAD_URL = "/downloads/CPU-Web-V6.apk";
