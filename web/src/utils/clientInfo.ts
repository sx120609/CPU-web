...
export const ANDROID_APP_LATEST_VERSION_CODE = 28;
export const ANDROID_APP_LATEST_VERSION_NAME = "3.0.7";
export const ANDROID_APP_DOWNLOAD_FILE_NAME = "CPU-Web-Android-V28.apk";
