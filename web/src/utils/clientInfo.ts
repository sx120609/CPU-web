...
export const ANDROID_APP_LATEST_VERSION_CODE = 29;
export const ANDROID_APP_LATEST_VERSION_NAME = "3.0.8";
export const ANDROID_APP_DOWNLOAD_FILE_NAME = "CPU-Web-Android-V29.apk";
