...
export const ANDROID_APP_LATEST_VERSION_CODE = 35;
export const ANDROID_APP_LATEST_VERSION_NAME = "3.0.35";
export const ANDROID_APP_DOWNLOAD_FILE_NAME = "CPU-Web-Android-V35.apk";
